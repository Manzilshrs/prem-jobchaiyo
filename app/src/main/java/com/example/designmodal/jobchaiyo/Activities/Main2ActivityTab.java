...
public class Main2ActivityTab extends AppCompatActivity implements tab_profile_frag.OnLogoutListener{
...
//    }
    ...
    public void logoutperform() {
        ...
        Intent intent=new Intent(Main2ActivityTab.this,MainActivity.class);
